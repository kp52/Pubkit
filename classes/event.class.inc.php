...
// fill in values when names of TVs and fields differ
	...
	$this->tvs['pkVenue']		 = $fields['venue'];
	$this->tvs['pkEventContact'] = $fields['eventContact'];
...
// set required format for dates and options sets (no widgets applied by docmanager)
    ...
    $customFields['eventContact'] = (!empty($fields['pkEventContact'])) ? $fields['pkEventContact'] : "";
